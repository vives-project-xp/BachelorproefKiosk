...
<body <?php body_class();?>>
    ...
    <div class="topbar">
        ...
        <img src="<?php echo get_partone_url() ?>/recourses/images/megaman-nt-warrior-anime.gif" width="50px">
    </div>

    <div class="projectwrapper">
        <div class="splitter">
            <img src="<?php echo get_partone_url() ?>/recourses/images/ezgif.com-crop1.gif" class="splitter">
        </div>

        <div class="richtingbrochure">
            <?php 
                echo "<img src='<?php echo get_partone_url() ?>/recourses/folders/".get_the_title(get_the_ID()).".jpeg' id='imgrichting'>"
            ?>
        </div>
