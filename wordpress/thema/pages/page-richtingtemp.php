...
<body>
    ...
    <div class="topbar">
        ...
        <img src="../recourses/images/megaman-nt-warrior-anime.gif" width="50px">
    </div>
    ...
    <div class="projectwrapper">
        <h2>specialisatie</h2>
        <p id="specialisatie">bv: Game & entertainment</p>
        <p id="dagonderwijs">Dagonderwijs</p>

        <div class="splitter">
            <img src="../recourses/images/ezgif.com-crop1.gif" class="splitter">
        </div>

        <div class="richtingbrochure">
            <img src="../recourses/folders/jay d'hulster.png" id="imgrichting">
        </div>
